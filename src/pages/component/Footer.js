...
class Footer extends Component{
    render() {
        return (
            <Fragment>
                <footer className="flex flex-col pt-5 lg:px-10 mt-14 m-auto">
                    <div className="flex flex-col m-5 gap-10 md:grid md:grid-cols-2 lg:grid-cols-4">
                        <div>
                        ...
                        <div className="m-5 hidden md:block md:m-0 lg:pt-2">
                        ...
                        <div className="lg:pt-2">
                            ...
                            <div className="flex flex-col items-center gap-10 md:items-start md:gap-5">
                                <img src={require('../../Assets/Image/ebuId.png')} alt="" className="w-48 md:w-48" />
                                <img src={require('../../Assets/Image/cineOne21.png')} alt="" className="w-48 md:w-48" />
                                <img src={require('../../Assets/Image/hiflix.png')} alt="" className="w-48 md:w-48" />
                            </div>
                        </div>
                        <div className="lg:pt-2">
                            <span className="font-mulish">Follow US</span>
                            <div className="flex gap-10 font-mulish mb-5 justify-center md:flex-col md:gap-5 md:mt-5">

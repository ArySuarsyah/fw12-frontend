                ...
                <header className="flex flex-row justify-between h-20 mt-2 font-mulish bg-white">
                    <div className="flex justify-center items-end gap-20 mb-5 mt-14">
                        ...
                        <div className="flex gap-10 text-base font-bold">
                            <span className="hover:text-blue-700 cursor-pointer hover:scale-[1.1] drop-shadow-xl font-mulish">Home</span>
                            <span className="hover:text-blue-700 cursor-pointer hover:scale-[1.1] drop-shadow-xl font-mulish">List Movie</span>
                        </div>
                    </div>

...
// import DetailsInformation from "./profileComponent/DetailsInformation";
...
function MovieGrid({ movies }) {
    ...
    return (
        <div className="inline-block p-8 m-3 w-[13rem]  rounded border-2 border-[#dedede] bg-neutral-100 relative overflow-y-hidden text-center movieParent">
            ...
            <div className="grid grid-rows-[1fr_minmax(90px,_1fr)_0px]">
                ...
                <div className="self-end">
                    <a href="./details">
                        <button type="submit" className="font-mulish border-[1px] rounded border-blue-600 w-40 h-9 text-sm text-blue-500 bg-[#dedede]">
                        Detail
                        </button></a>
                </div>
            </div>

        ...
        <div className="mt-0 pt-0">
            ...
            <section>
                <div className="flex flex-row text-blue-700 justify-between bg-white my-5 font-semibold cursor-pointer px-14">
                    ...
                    <span onClick={view} className="hover:scale-[1.1] font-mulish drop-shadow-xl cursor-pointer">view all</span>
                </div>
                <Movielist />
            ...
            <section>
                <div className="flex flex-row text-blue-700 justify-between bg-white my-5 font-semibold cursor-pointer px-14">
                    ...
                    <span onClick={view} className="font-mulish text-sm hover:scale-[1.1] drop-shadow-xl">view all</span>
                </div>
                <div>
                </div>
